...
export const de: LocaleDict = {
  config: {
    ...
    protectedPaths: {
      ...
      subtitle: "Liste der Laufwerke oder Pfade, für die alle Vorgänge blockiert werden sollen (z. B. D:\\, C:\\Windows). Eine pro Zeile. ⚠️ Shell-Befehle können durch Pfadabgleich nicht vollständig blockiert werden – als Schutzmaßnahme verwenden, nicht als Sicherheitsgrenze.",
    },
    searchApiKey: {
